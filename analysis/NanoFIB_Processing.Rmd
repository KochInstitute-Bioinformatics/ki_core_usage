...
#   ))
# 
# cat("Dimensions of Service.Group.working dataframe:", dim(as.data.frame(table(ilabs.nano$Service.Group.working))), "\n")
# 
# msbp.Service.Group.working.df <- as.data.frame(table(ilabs.nano$Service.Group.working))
...
## Join Service.Group to ilabs.nano
...
## Join the 2 different rate modifiers to ilabs.nano using SponsorCategory
