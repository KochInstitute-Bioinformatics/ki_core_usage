...
```{r}
table(ilabs.pmit$Charge.Name.Short)
```
...
#   ))
# 
# cat("Dimensions of Service.Group.working dataframe:", dim(as.data.frame(table(ilabs.pmit$Service.Group.working))), "\n")
# 
# msbp.Service.Group.working.df <- as.data.frame(table(ilabs.pmit$Service.Group.working))
...
## Join Service.Group to ilabs.pmit
...
## Join the 2 different rate modifiers to ilabs.pmit using SponsorCategory
